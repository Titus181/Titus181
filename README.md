...
Currently serving as a **Probability Engineer at Bosi Consulting**, I specialize in mathematical modeling, on-chain data analysis, and full-stack development. As an **IBM Certified Data Scientist**, I bridge the gap between complex numerical systems and actionable Web3 growth strategies.
...
| --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------- |
| 🎲 **Game Mechanics & Probability Modeling** | (Current @ Bosi) Designing and verifying complex numerical models for gaming systems, ensuring mathematical integrity and balance through rigorous simulation. | Probability Theory, C++, Statistics, Numerical Analysis |
| 📊 **L2 Ecosystems & Airdrop Strategy Analysis** | In-depth analyses on Web3 ecosystems. Dissected airdrop retention for **Arbitrum/Optimism** and benchmarked ecosystem health using UAW vs. TVL metrics. | Python, SQL, On-Chain Data, Web3 Strategy |
| 🎮 **Online Gaming Platform (Professional Work)** | Developed front-end (Vue.js) and back-end (PHP, MySQL) systems for a large-scale gaming platform, focusing on system stability and high-concurrency optimization. | Vue.js, PHP, MySQL, System Optimization |
...
<p>
  <img src="https://img.shields.io/badge/Probability_Modeling-E10098?style=for-the-badge&logo=mathworks&logoColor=white" alt="Probability">
...
# 許智翔 (Titus Hsu) | 博思顧問 數值工程師 | Web3 數據分析師 & 全端開發者
...
目前在 **博思顧問 (Bosi Consulting)** 擔任 **數值工程師 (Probability Engineer)**。我是一位結合數值建模、鏈上數據分析與全端開發背景的 Web3 Builder。作為 **IBM 認證數據科學家**，我致力於將複雜的數學模型轉化為穩健的系統邏輯與具備洞察力的增長策略。
...
| 專案                                          | 描述                                                                                                                                                                                                   | 技術棧 / 關鍵字                                             |
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------- |
| 🎲 **遊戲機制與數值建模** | (博思顧問工作) 負責開發與驗證複雜的遊戲數值模型，透過嚴謹的數學模擬與機率分析，確保系統的公平性、穩定性與數學平衡。 | 機率論, C++, 統計分析, 數值運算 |
| 📊 **L2 生態與空投策略分析** | 深度分析報告。剖析 **Arbitrum/Optimism** 的空投留存效益，並使用 UAW 與 TVL 指標評估主流 L1/L2 公鏈的生態健康度。 | Python, SQL, 鏈上數據分析, Web3 策略 |
| 🎮 **線上遊戲平台 (工作專案)** | 負責大型遊戲平台的前後端開發。優化高併發場景下的系統穩定性，並打造能創造實際營收的核心功能。 | Vue.js, PHP, MySQL, 系統優化 |
...
-   💡 作為 **Might DAO** 的活躍貢獻者，我不僅提供數據洞察，也積極參與 Web3 社群交流，打造連結數據、數學與技術的產品。
